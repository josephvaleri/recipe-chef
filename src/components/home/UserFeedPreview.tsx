// components/home/UserFeedPreview.tsx
import { getGlobalAcceptedRecipes } from "@/lib/community/queries";
...
export default async function UserFeedPreview() {
  const globalRecipes = await getGlobalAcceptedRecipes(5);
